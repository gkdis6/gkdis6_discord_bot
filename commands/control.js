...
import { is_same_vc_as, make_simple_embed, make_playing_embed, get_control_button_row, create_yt_data_from_playdl_data } from "../utils/utils.js";
...
export async function execute(interaction) {
  ...
  await interaction.channel.send({
    embeds: [make_playing_embed(interaction.guildId, interaction.member, yt_data)],
